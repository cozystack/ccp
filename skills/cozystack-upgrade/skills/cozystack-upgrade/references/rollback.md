...
kubectl get packages.cozystack.io -A -o yaml      > pre-rollback-backup/packages.yaml
kubectl get packagesources.cozystack.io -A -o yaml > pre-rollback-backup/packagesources.yaml
kubectl get hr -A -o yaml                          > pre-rollback-backup/helmreleases.yaml
kubectl get configmap -n cozy-system -o yaml       > pre-rollback-backup/cozy-system-cms.yaml
helm history cozystack -n cozy-system              > pre-rollback-backup/helm-history.txt
```
...
# Compare HR count
kubectl get hr -A --no-headers | wc -l
